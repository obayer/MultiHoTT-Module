...
void i2c_OLED_Print(const char *string){  // Sends a string of chars untill null terminator
  unsigned char i=0;
  while(*string){
    for(i=0;i<6;i++){
...
void print_Cell(uint16_t volt) {
  char line[6] = "-,--V";
  line[0] = digit100(volt);
  line[2] = digit10(volt);
  line[3] = digit1(volt);
  LCD_Print(line);
}

void print_VBAT(uint16_t volt) {
  char line[6] = "--,-V";
  line[0] = digit100(volt);
  line[1] = digit10(volt);
  line[3] = digit1(volt);
